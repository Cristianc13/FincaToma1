...
namespace FincaToma1.Controllers
{
    public class UbicacionesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("IDU,NombreU")] Ubicacion ubicacion)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IDU,NombreU")] Ubicacion ubicacion)
        {
            if (id != ubicacion.IDU)
            {
                return NotFound();
            ...
            if (ModelState.IsValid)
            {
                ...
                {
                    if (!UbicacionExists(ubicacion.IDU))
                    {
                        return NotFound();
                    }
                    else
        ...
        {
            return _context.Ubicacion.Any(e => e.IDU == id);
        }
    }
}
